...
This repository owns `ReverseTrendLine` and `TrendLine` strategy behavior, configuration, adapters, figures, and tests.
...
- Keep the shared TrendLine family mechanics in this repository; both strategies must remain releasable as one package.
